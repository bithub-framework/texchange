...
export declare class OrderValidator<H extends HLike<H>> {
    ...
    private makers;
    private calculator;
    constructor(context: VirtualMachineContextLike<H>, marketSpec: MarketSpec<H>, accountSpec: AccountSpec, makers: Makers<H>, calculator: AvailableAssetsCalculator<H>);
