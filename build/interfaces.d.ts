...
import { Trade, Positions, Balances, LimitOrder, OpenMaker, Orderbook, OpenOrder, MarketSpec, AccountSpec, ContextMarketApiLike, ContextAccountApiLike } from 'interfaces';
...
export interface AccountConfig extends AccountSpec {
    calcInitialMargin: (ctx: Spec & MarketInfo & {
        order: LimitOrder;
    }) => Big;
    calcPositionMarginIncrement: (ctx: Spec & MarketInfo & TradesInfo & {
        order: OpenOrder;
    }) => Big;
    calcPositionMarginDecrement: (ctx: Spec & MarketInfo & TradesInfo & EquityManagerProps & MarginManagerProps) => Big;
    calcFreezingMargin: (ctx: Spec & MarketInfo & {
        order: OpenMaker | LimitOrder;
    }) => Big;
    calcPositionMarginOnSettlement: (ctx: Spec & MarketInfo & EquityManagerProps & MarginManagerProps) => Big;
    shouldBeCompulsorilyLiquidated: (ctx: Spec & MarketInfo & EquityManagerProps & MarginManagerProps) => boolean;
    calcTotalPositionMargin: (ctx: Spec & MarketInfo & EquityManagerProps & MarginManagerProps) => Big;
}
