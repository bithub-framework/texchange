...
const user_order_handler_1 = require("../middlewares/user-order-handler");
...
class Container extends injektor_1.BaseContainer {
    constructor() {
        ...
        this[_f] = this.rcs(broadcast_1.Broadcast);
        this[_g] = this.rcs(database_trade_handler_1.DatabaseTradeHandler);
        this[_h] = this.rcs(user_order_handler_1.UserOrderHandler);
        this[_j] = this.rcs(order_validator_1.OrderValidator);
